...
export default function PublicHomePage() {
    return (
        <main className="mx-auto flex min-h-[70vh] w-full max-w-4xl flex-col items-start justify-center gap-4 px-4 sm:px-6 lg:px-8">
            <p className="text-xs font-medium uppercase tracking-wide text-primary">Welcome to the Seller Marketplace</p>
            ...
            <p className="max-w-2xl text-sm text-muted-foreground sm:text-base">
                quick start tapping Browse Ads or If you want to register tap Login with Google
            </p>
